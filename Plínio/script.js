...
function changeHpFlamel() {
    ...
    if (hpAtual == 0) {
        $('#healthflamel').attr('aria-valuemax', 210).css('width', 210 + 'px');
        $('#healthflamel').attr('aria-valuenow', hpMax).css('width', 210 + 'px');
        $('#hpbarflamel').css('width', 210 + 'px');
        $('#hpnumberflamel').text(hpMax + '/' + hpMax);
    } else {
        $('#healthflamel').attr('aria-valuemax', hpMax).css('width', 210 + 'px');
        $('#hpbarflamel').css('width', 210 + 'px');
